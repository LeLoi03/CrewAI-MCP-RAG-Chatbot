...
# Import tool đã được tạo bằng phương thức của crewai_tools
from app.tools.get_conferences_tool import get_conferences_tool

# --- Định nghĩa các Agent chuyên gia ---

conference_researcher = Agent(
...
"""
    ...
    # Bây giờ, tool này hoàn toàn tương thích
    tools=[get_conferences_tool],
    llm=sub_agent_llm,
    verbose=True,
